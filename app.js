...
iotfClient.on("connect", function () {
    ...
    setInterval(function(){
        ...
        //
        // increment temperatura up to 100 then back down to 0
        //
        //if (dataPacket.d.temperatura === 0) {
        //   var countingUp = true;
        //} else if (dataPacket.d.temperatura === 100) {
        //   var countingUp = false;
        //}
        //if (countingUp === true) {
        //    if (dataPacket.d.temperatura === 100) {
        //       var countingUp = false;
        //    } else1{
        //       var countingUp = true;
        //    }
        //    var temperaturaIncrement = 20;
        //} else {
        //    if (dataPacket.d.temperatura === 0) {
        //       var countingUp = true
        //    } else {
        //       var countingUp = false;
        //    }
            var temperaturaIncrement = 7;
            //var temperaturaDecrement = 3.7;
          //  var luminosityIncrement = 1;
        //}
        //if (dataPacket.d.temperatura === 100) {
          //  dataPacket.d.temperatura = 0;
        //}
        if(dataPacket.d.temperatura<64 && flag){
            dataPacket.d.temperatura = dataPacket.d.temperatura + temperaturaIncrement;
            flag = true;            
        }else if(dataPacket.d.temperatura>64){
            dataPacket.d.temperatura = dataPacket.d.temperatura - temperaturaIncrement;
            flag = false;
        }else if(dataPacket.d.temperatura === 20 && !flag){
        ...
        //}
        //dataPacket.d.humidity = dataPacket.d.humidity + temperaturaDecrement;


        //
        // increment the distance until 100 and start again at 0
        //
        //var temperaturaDecrement = 1;
        //if (dataPacket.d.distance === 100) {
          //  dataPacket.d.distance = 0;
        //}
        //dataPacket.d.distance = dataPacket.d.distance - temperaturaDecrement;
